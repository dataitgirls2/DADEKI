...
function get_chart(target, data, w, h, levels, maxValue) {
  function getDataset() {
  ...
  RadarChart.defaultConfig.levels = levels;
  RadarChart.defaultConfig.maxValue = maxValue;

  var svg = d3.select(target).append('svg')
    .attr('width', cfg.w + cfg.w + 50)
    .attr('height', cfg.h + cfg.h / 4);
  svg.append('g').classed('single', 1).datum(getDataset()).call(chart);
